...
nslookup 192-168-208-21.default.pod.cluster.local $SERVICEIP
...
------------------DESCARGAR CONFIG ANTES

kubectl get configmaps --namespace kube-system coredns -o yaml > configinit.yaml

DOWNLOAD  configinit.yaml
